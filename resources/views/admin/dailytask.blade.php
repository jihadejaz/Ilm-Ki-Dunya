                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @isset($msg)
                                        @if (isset($msg))
                                            <?php
                                            if ($msg == 'Task sucessfully uploaded') {
                                                $class = 'text-success';
                                            } else {
                                                $class = 'text-danger';
                                            }
                                    ...
                                    <h4 class="card-title"> upload Daily Task </h4>
                                    <p class="card-description"> Basic form elements </p>
                                    <form class="form" action="{{ route('insert_task') }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputName1">Task Tittle</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-xs-12">
                                                <input type="text" class="form-control file-upload-info"
                                                    placeholder="Upload mp4/pdf/pic">
                                                <span class="input-group-append">
                                                    <button class="file-upload-browse btn btn-primary" type="button"
                                                        onclick="$('#uploadFile').trigger('click')">Upload
                                                    </button>
                                                </span>
                                            </div>
                                        </div>
