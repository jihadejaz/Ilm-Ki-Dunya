    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
                <h2 class="text-dark font-weight-bold mb-2"> Overview Templetes </h2>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content tab-transparent-content">
                            <div class="tab-pane fade show active" id="business-1" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-12 col-sm-12 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body text-center">
                                                <p class="mt-4 mb-0">Active</p>
                                                <h3 class="mb-0 font-weight-bold mt-2 text-dark">Coming Soon
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
